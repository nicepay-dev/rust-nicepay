...
use rust_nicepay::models::v1::regist_direct_model::RegistDirectV1Model;
...
let req_direct: RegistDirectV1Model = RegistDirectV1Model {
    // Required fields
    merchant_token: merchant_token,
    pay_method: "01".to_string(),
    currency: "IDR".to_string(),
    // bank_cd: Some("CENA".to_string()),
   //mitra_cd : Some("ALMA".to_string()),
    amt: amt.to_string(),
    ...
    instmnt_type: Some("1".to_string()),
    instmnt_mon: Some("1".to_string()),
    one_pass_token : Some("8deb905ca0e3aba4633e68d2b55c7fcef634a732bdaa970e5761c07d516b6576".to_string()),
    cart_data: r#"{"count":"1","item":[{"img_url":"","goods_name":"Product A","goods_detail":"Test","goods_amt":"10000"}]}"#.to_string(),
